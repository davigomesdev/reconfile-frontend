...
interface ChartComponent
  ...
  LegendContent: typeof LegendContent;
  Style: typeof Style;
}
...
const Style = ({ id, config }: { id: string; config: ChartConfig }): React.JSX.Element | null => {
...
const getPayloadConfigFromPayload = (config: ChartConfig, payload: unknown, key: string): any => {
...
(Chart as ChartComponent).Tooltip = Tooltip;
(Chart as ChartComponent).TooltipContent = TooltipContent;
(Chart as ChartComponent).Legend = Legend;
(Chart as ChartComponent).LegendContent = LegendContent;
(Chart as ChartComponent).Style = Style;

export default Chart as ChartComponent;
